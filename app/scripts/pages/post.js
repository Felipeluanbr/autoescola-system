...
async function initPost() {
    ...
    if (!post) {
        document.getElementById("content__post").innerHTML = "<h1>Post não encontrado.</h1>";
        return;
    }
    ...
    bannerPost.style.backgroundImage = `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${post.image})`;
